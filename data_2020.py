...
if n == 'ipeit' :
    folder_path = r'C:\Users\moham\OneDrive\Documents\cnc rang\ipeit\2020'
...
#list of all results_2020 

for file_path in file_paths :
    result =  scan(file_path)
    results_2020.append(result)
#tandhifa
results_2020 = [int(n) for n in re.findall(r'-?\d+(?:\.\d+)?', str(results_2020))]
def sort():
    results_2020.sort()
    return results_2020
sort()